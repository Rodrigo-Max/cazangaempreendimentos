...
class export_table_to_csv{
    ...
    function generate_csv(){
        ...
        $table = 'p_' . $this->table_name;             //For flexibility of the plugin and convenience, lets get the prefix
        ...
        $values = $this->db->get_results("SELECT * FROM " . $table . " ORDER BY dat_cadastro");       //This here

        foreach ($values as $rowr) {
            //$rowr = array_map( 'utf8Fix', (array) $rowr);
            $rowr = array_map( 'utf8_decode', (array) $rowr);
